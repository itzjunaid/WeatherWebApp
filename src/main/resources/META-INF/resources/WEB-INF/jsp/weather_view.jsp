...
<header>
	<p>
		Created by Maniyar Junaid | Using Open Weather Map API from RapidAPI | 
		<a href = "https://github.com" target = "_blank">GitHub for code</a>
	</p>
</header>
	...
	<div id = "weather_search" class = "card-body" align = "center">
		...
		<h3>Weather Web App: Get the current weather for your city.</h3><br/>
